...
**GNC & Autonomy**  
`ROS2` `PX4` `MAVROS` `SLAM (Cartographer)` `AMCL` `NavFn/DWA` `Motion Planning` `TF Frames`
...
### 🤖 [Multi-UAV Safe Control — GCBF+ on Crazyflie (Safe Robotics Lab, ASU)](https://github.com/rohitsanjay-17-aerohub)
> *ROS2 · Crazyflie · Graph Neural Networks · Safe Multi-Agent Control*

Deployed a ROS2 node on **8 physical Crazyflie nano-UAVs**, integrating the **Neural Graph Control Barrier Function (GCBF+)** framework for decentralized, collision-free multi-agent control. Real-time GNN inference enabled dynamic obstacle avoidance and safe position swapping, validated through structured flight tests on physical hardware.

---

### ✈️ [6-DOF Aircraft Dynamics, Trim & Stability Analysis](https://github.com/rohitsanjay-17-aerohub/6DOF-Aircraft-Simulation)
...
### 🛸 [ROS2 Autonomous Navigation Stack (ROSMASTER X3)](https://github.com/rohitsanjay-17-aerohub)
> *ROS2 · SLAM · EKF · Jetson Nano · Gazebo SITL*

Led a 6-person team to deploy a **full ROS2 autonomous navigation stack** on physical hardware — integrating Cartographer SLAM, AMCL localization, and NavFn/DWA planning. Fused IMU + wheel odometry via **Extended Kalman Filter**; validated in Gazebo before field deployment on a Jetson Nano.

---

### 🔧 [Scaled VTOL UAV — F-35 Inspired (Flight Controls Lead)](https://github.com/rohitsanjay-17-aerohub)
> *C++ · dRehmFlight · PID Tuning · Python Log Analysis*
...
### 📐 [Linear MPC — Constrained Trajectory Control](https://github.com/rohitsanjay-17-aerohub)
> *Python · Model Predictive Control · Trajectory Optimization*
...
- **IIT Kanpur**: Executed real flight experiments on Cessna 206H, Piper Saratoga, and NAL Hansa aircraft — extracted drag polars, CG determination, and neutral point from live flight data.
